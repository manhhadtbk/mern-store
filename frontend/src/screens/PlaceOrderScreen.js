...
export default function PlaceOrderScreen() {
   ...
   cart.shippingPrice = cart.itemsPrice > 100 ? round2(0) : round2(/* 1 */0);
   cart.taxPrice = round2(0/* .15 */ * cart.itemsPrice);
   if (cart.paymentMethod === "PayPal") {
      cart.totalPrice = (cart.itemsPrice + cart.shippingPrice + cart.taxPrice) * 0.9
   } else {
               ...
               <Card>
                  <Card.Body>
                     ...
                     <ListGroup variant="flush">
                        ...
                        {((cart.paymentMethod === "PayPal")) && (<ListGroup.Item>
                           <Row>
                              <Col>Free</Col>
                              <Col>${(cart.itemsPrice + cart.shippingPrice + cart.taxPrice) * 0.1}</Col>
                           </Row>
                        </ListGroup.Item>)}
                        <ListGroup.Item>
                           <Row>
